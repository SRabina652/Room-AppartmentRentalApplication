...
public class DisplayReviewAndRating extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RatingAndReviewModel rrmodel= new RatingAndReviewModel();

        //think here
        FirebaseRecyclerOptions<RatingAndReviewModel> options =
                new FirebaseRecyclerOptions.Builder<RatingAndReviewModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Rooms").limitToFirst(10), RatingAndReviewModel.class)
                        .build();
